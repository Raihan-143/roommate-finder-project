  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-14">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {roommates.map((r) => (
          <Fade key={r.id} triggerOnce>
            <div className="bg-white rounded-2xl shadow hover:shadow-xl transition duration-300 p-5 flex flex-col items-center text-center ">
              <img
                src={r.image}
                alt={r.name}
      ...
      <div className="text-center mt-10">
        <button className="px-6 py-2 bg-gray-100 text-indigo-700 font-semibold rounded-full hover:bg-indigo-200 transition">
          See More Roommates →
        </button>
      </div>
    </div>
